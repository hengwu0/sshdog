...
func (s *Server) ListenAndServe(port int16) {
...
func (s *Server) VerifyPassword(c ssh.ConnMetadata, pass []byte) (*ssh.Permissions, error) {
	pws, err := readPasswd()
	if err != nil {
		return nil, err
	}
